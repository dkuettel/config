...
# TODO what I got from diff on 'zstyle'
...
# TODO not sure how to make it work yet, doing anything?
zstyle ':completion:*' use-cache yes
zstyle ':completion:*' cache-path $HOME/.zcompcache

# TODO some more styles where there for some url quote magic
# probably never activated anyway for me

# NOTE there is some kill completion above, often overwritten by fzf right now

zmodload zsh/complist
autoload -U compinit
# NOTE slow, can we lazy load it on first tab or something?
# TODO where to put dumpfile? leave at default? for now explicit so see what's happening
compinit -d ~/.zcompdump
# TODO use -C to disable check for refresh, makes it faster, but doesnt refresh automatically
# bashcompinit if trying to use completion specified for bash, needed?

# TODO ctlr-j and k might be nice for navigating, als h and l? if possible?
